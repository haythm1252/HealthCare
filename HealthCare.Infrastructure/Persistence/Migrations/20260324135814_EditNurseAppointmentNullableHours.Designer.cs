...
namespace HealthCare.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260324135814_EditNurseAppointmentNullableHours")]
    partial class EditNurseAppointmentNullableHours
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HealthCare.Domain.Entities.DoctorAppointment", b =>
                {
                    ...
                    b.HasOne("HealthCare.Domain.Entities.DoctorSlot", "DoctorSlot")
                        ...
                        .HasForeignKey("HealthCare.Domain.Entities.DoctorAppointment", "DoctorSlotId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
